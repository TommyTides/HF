<?php include __DIR__ . '/../jazz_header.php'; ?>
<section id="featured-artists" class="d-flex justify-content-center flex-column bg-main">
...
<section id="event-location">
    <div class="container d-flex flex-row p-3">
        <div class="flex-grow-1">
            ...
            <p class="h5 fw-normal text-uppercase mb-3"><?= $location->getMotto() ?></p>
            <p class="mt-1 pr-3"><?= $location->getDescription() ?></p>
        ...
        <div class="flex-grow-1">
            <img class="card-img-top rounded-0 custom-max-height custom-width custom-height" src="/img/locations/<?= strtolower(str_replace(' ', '', $location->getName())) ?>-primary.jpg">
        </div>
    </div>
</section>
    ...
    <div class="container d-flex flex-row mt-3 justify-content-center">
        ...
        ?>
            <div id="event" class="pb-4">
                ...
                <a class="btn btn-danger rounded-0" href="/dance/event?id=<?= $product->getEventId() ?>">See event</a>
            </div>
            <?php
            $i++;
            if ($i != $count) {
